...
class Auth extends CI_Controller
{
    ...
    private function _sendEmail($token, $type)
    {
        $config  = [
            ...
            'smtp_user' => 'maeztro5674@gmail.com',
            'smtp_pass' => 'senojaya123',
            'smtp_port' => 465,
            'mailtype'  => 'html',
            'charset'   => 'utf-8',
            'newline'   => "\r\n"
        ...
        $this->email->from('maeztro5674@gmail.com', 'missMb');
    ...
    public function resetpassword()
    {
        ...
        if ($user) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">EReset password failed! Wrong email.</div>');
            redirect('auth');
        }
    }
